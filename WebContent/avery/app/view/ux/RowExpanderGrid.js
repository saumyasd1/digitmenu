...
Ext.define('AOC.view.ux.RowExpanderGrid', {
	 ...
	 */
	    ...
	    init: function(grid) {
	        ...
	        view.on('collapsebody', this.onCollapse, this);
	    ...
	    onExpand: function(rowNode, record, expandRow) {
	        ...
	        if( Ext.isEmpty( this.obj_recordId_componentId[id] ) ) {
	            ...
	            this.obj_recordId_componentId[id] = newComponent.getId() ;
	        }
	    },
	    ...
	    var reusedCmpIds = [] ;
	       ...
	       if( !Ext.isEmpty(this.obj_recordId_componentId[id]) ) {
                ...
                var reusedComponent = Ext.getCmp(this.obj_recordId_componentId[id]),

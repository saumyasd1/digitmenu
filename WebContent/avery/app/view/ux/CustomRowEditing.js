//This is the exact copy of RowEditor from extjs code. Coping this seems to make the position of editor zccurate- no idea why
        ...
        if (column && !column.isDestroyed) {   
            if (column.isVisible()) {
                ...
                if (field && field.isFocusable(true)) {
                    didFocus = true;
                    Ext.defer(field.focus,10,field);
                }
            }
            if (!didFocus) {

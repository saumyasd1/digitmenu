Ext.define('AOC.view.users.myprofile.AddUserWindowController', {
    ...
    onSiteSelected: function (field) {
        ...
        Helper.getSystemComboList(siteId);
        systemStore.load();
    ...
    insertDataIntoGrid: function (obj) {
        var me = this,
            ...
            obj = {
                systemName: systemComboValue,
                orgCode: orgCodeComboValue,
                csrCode: csrCodeComboValue,
                codeOwner: codeOwnerComboValue,
                csrCodeComboId: csrCodeComboId,
                id: csrCodeComboId
            };

Ext.define('AOC.util.Helper', {
    ...
    onOrderLineDateRenderer: function (v, metadata, record) {
        if (!Ext.isEmpty(v) && new Date(Ext.util.Format.dateRenderer()(record.get('orderedDate'))) > new Date(Ext.util.Format.dateRenderer()(v)) && record.get('status') == AOCLit.waitingForCSRStatusOrderLine) {
            metadata.style = AOCLit.cellColor;

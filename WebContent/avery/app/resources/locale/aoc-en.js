Ext.define('AOC.lang.lit',{
   ...
   "hideImage":"background-image:url();background-repeat:no-repeat;background-position:right",
    ...
    "bulkItem":'Bulk Item',
    "averyMOQ":'Avery MOQ',
    "averyProduction":'Avery ProductLine Type',
    ...
    "systemCountMsg": "No System Configured for the selected site. Please select another site",
    "orgCountMsg": "No Org Configured for the selected system. Please select another system",
    ...
    "editOrderLineTitle":'Edit Order Line',
    "fromDate": 'From Date',
    "toDate": 'To Date',
    "dateFormat":'Y-m-d',
    ...
    "custPONumber":'Customer PO#/Contract#',
    "PONumber": 'PO#',
    ...
    "artworkWorkAttachment":'Artwork for Reference',
    ...
    "viewSalesOrderBtnText": 'View Sales Order',
    "cancelSalesOrderText":'Cancel Order',
    "salesOrdersumbitText": 'Submit Sales Order',
    "cancelOrderText" :'<b>Are you sure you want to cancel the Order? If yes, please enter the reason for further reference:</b> ',
    "moveToTaskManagerText" :'<b>Are you sure you want to move this email to task manager? If yes, please enter the reason for further reference:</b> ',
    "disregardEmailText":'<b>Are you sure you want to disregard the Email? If yes, please enter the reason for further reference:</b> ',
    ...
    'RBOName': 'RBO Name',
    "CSREmail": 'CSREmail',
    "orderEmailDomain": 'Order Email Domain',
    "packagingInstruction": 'Packing Instruction',
    "invoiceLineInstruction": 'Invoice Line Instruction',
    "variableDataBreakDown": 'Variable Data Breakdown',
    "manufacturingNotes": 'Manufacturing Notes',
    "shippingOnlyNotes": 'Shipping Only Notes',
    "updateProdLineMsg":'Partner Data Structure Updated Successfully',
    "addProdLineMsg":'Partner Data Structure Added Successfully',
    "entryExistMsg":'<font size=2 color=red> Duplicate entry for Data Structure Name.</font>',
    "addPartProdLine":'Add Partner Product Line',
    "editPartProdLine":'Edit Partner Product Line',
    "delPartProdLine":'<b>Are you sure,you want to delete this product line</b>',
    "deleteProdLineMsg":'Partner Data Structure Deleted Succesfully',
     //Password
    ...
    "fillMandatoryCellMsg": 'Please fill valid entry in the cell marked as red before proceeding',
    ...
    addressExistMsg:'An entry already exist for given site address',
	...
	orderFileKeywordEmptyText:'eg:NIKE AND Nike PO / Nike OR NIKE / NIKE',
	orderFileCellNoEmptyText:'eg:A1 AND A2 / A1 OR A1 / A1',
	
	maxGroupingFieldCount:29

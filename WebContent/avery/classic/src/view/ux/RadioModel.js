Ext.define('AOC.view.ux.RadioModel', {
     ...
     */
    checkSelector: '.' + Ext.baseCSSPrefix + 'grid-row-radio',
    ...
    // private
    checkerOnCls: Ext.baseCSSPrefix + 'grid-hd-radio-on',
    
    tdCls: Ext.baseCSSPrefix + 'grid-cell-special ' + Ext.baseCSSPrefix + 'grid-cell-row-radio',
    ...
    onHeaderClick: function(headerCt, header, e) {
        if (header === this.column) {
            e.stopEvent();
            var me = this,
                isChecked = header.el.hasCls(Ext.baseCSSPrefix + 'grid-hd-radio-on');
    ...
    getHeaderConfig: function() {
        ...
        return {
            ...
            dataIndex: '',
            tdCls: me.tdCls,
            cls: showCheck ? Ext.baseCSSPrefix + 'column-header-radio ' : '',
     ...
     * Creates the standard radio markup by default; can be overridden to provide custom rendering.
     */
    renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
    		return '<div class="' + Ext.baseCSSPrefix + 'grid-row-radio" role="presentation">&#160;</div>';
    },

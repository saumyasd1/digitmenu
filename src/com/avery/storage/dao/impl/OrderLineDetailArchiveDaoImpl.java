...
@Repository
public class OrderLineDetailArchiveDaoImpl extends GenericDaoImpl<OrderLineDetailArchive, Long> implements
OrderLineDetailArchiveDao {

	@Override
	public Long create(OrderLineDetailArchive newInstance) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public OrderLineDetailArchive read(Long id) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public Map getAllEntitiesWithCriteria(MultivaluedMap queryMap)
		...
		criteria = session.createCriteria(OrderLineDetailArchive.class);
        ...
        entitiesMap.put("ar_orderlinedetail", new LinkedHashSet(criteria.list()));
		return entitiesMap;
	}
}

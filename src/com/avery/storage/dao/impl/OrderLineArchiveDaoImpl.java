...
@Repository
public class OrderLineArchiveDaoImpl extends GenericDaoImpl<OrderLineArchive, Long> implements
OrderLineArchiveDao {

	@Override
	public Long create(OrderLineArchive newInstance) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public OrderLineArchive read(Long id) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public Map getAllEntitiesWithCriteria(MultivaluedMap queryMap)
		...
		criteria = session.createCriteria(OrderLineArchive.class);
        ...
        entitiesMap.put("ar_orderline", new LinkedHashSet(criteria.list()));
		return entitiesMap;
	}
}
